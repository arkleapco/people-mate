...
class Payment_Type(models.Model):
    ...
    end_date = models.DateField(auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE,
                                   related_name='payment_type_created_by')
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE)
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)
...
class Payment_Method(models.Model):
    ...
    end_date = models.DateField(auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE,
                                   related_name='payment_method_created_by')
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE)
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)
...
class Payroll_Master(models.Model):
    enterprise = models.ForeignKey(Enterprise, on_delete=models.CASCADE, related_name='payroll_enterprise',
                                   verbose_name=_('Enterprise Name'))
...
class Assignment_Batch(models.Model):
    payroll_id = models.ForeignKey(Payroll_Master, on_delete=models.CASCADE, null=True, blank=True,
                                   related_name='assign_batch_payroll', verbose_name=_('Payroll'))
    ...
    end_date = models.DateField(auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE,
                                   related_name='assignment_batch_created_by')
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE)
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)
...
class Assignment_Batch_Include(models.Model):
    include_batch_id = models.ForeignKey(Assignment_Batch, on_delete=models.CASCADE, null=True, blank=True,
                                         related_name='assign_include_batch', verbose_name=_('Exclude Batch Id'))
    dept_id = models.ForeignKey(Department, on_delete=models.CASCADE, null=True, blank=True,
                                related_name='assign_include_dept', verbose_name=_('Department'))
    position_id = models.ForeignKey(Position, on_delete=models.CASCADE, null=True, blank=True,
                                    related_name='assign_include_position', verbose_name=_('Position'))
    job_id = models.ForeignKey(Job, on_delete=models.CASCADE, null=True, blank=True, related_name='assign_include_job',
                               verbose_name=_('Job'))
    emp_id = models.ForeignKey('employee.Employee', on_delete=models.CASCADE, null=True, blank=True,
                               related_name='assign_include_emp', verbose_name=_('Employee'))
    start_date = models.DateField(auto_now=False, auto_now_add=False, default=date.today, verbose_name=_('Start Date'))
    end_date = models.DateField(auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE,
                                   related_name='assignment_include_created_by')
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE)
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)
...
class Assignment_Batch_Exclude(models.Model):
    exclude_batch_id = models.ForeignKey(Assignment_Batch, on_delete=models.CASCADE, null=True, blank=True,
                                         related_name='assign_exclude_batch', verbose_name=_('Deduction'))
    dept_id = models.ForeignKey(Department, on_delete=models.CASCADE, null=True, blank=True,
                                related_name='assign_exclude_dept', verbose_name=_('Department'))
    position_id = models.ForeignKey(Position, on_delete=models.CASCADE, null=True, blank=True,
                                    related_name='assign_exclude_postion', verbose_name=_('Position'))
    job_id = models.ForeignKey(Job, on_delete=models.CASCADE, null=True, blank=True, related_name='assign_exclude_job',
                               verbose_name=_('Job'))
    emp_id = models.ForeignKey('employee.Employee', on_delete=models.CASCADE, null=True, blank=True,
                               related_name='assign_exclude_emp', verbose_name=_('Employee'))
    start_date = models.DateField(auto_now=False, auto_now_add=False, default=date.today, verbose_name=_('Start Date'))
    end_date = models.DateField(auto_now=False, auto_now_add=False, blank=True, null=True, verbose_name=_('End Date'))
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE,
                                   related_name='assignment_exclude_created_by')
    creation_date = models.DateField(auto_now=True, auto_now_add=False)
    last_update_by = models.ForeignKey(settings.AUTH_USER_MODEL, blank=False, on_delete=models.CASCADE)
    last_update_date = models.DateField(auto_now=False, auto_now_add=True)
