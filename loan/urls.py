...
urlpatterns =[
    ...
    path('loan/<int:pk>/', views.get_loan, name='get-loan'),
    path('loan/create/', views.create_loan, name='create-loan'),
    path('loan/update/<int:pk>/', views.update_loan_type, name='update-loan-type'),
    path('loan/delete/<int:pk>/', views.delete_loan_type, name='delete-loan-type'),
