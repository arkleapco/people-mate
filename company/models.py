...
class Department(MPTTModel):
    ...
    oracle_erp_id = models.CharField(max_length=100, null=True, blank=True,  verbose_name=_('Oracle ID'))
    cost_center = models.CharField(max_length=100, null=True, blank=True,  verbose_name=_('Cost Center'))
...
class Working_Hours_Deductions_Policy(models.Model):
    ...
    last_update_date = models.DateField(auto_now=False, auto_now_add=True,  blank=True, null=True)
...
class DepartmentIntegration(models.Model):
    ...
    last_update_date = models.CharField(max_length=255,null=True , blank = True)
