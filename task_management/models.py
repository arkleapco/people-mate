...
class Project(models.Model):
    ...
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='project_created_by')
...
class Project_Task(models.Model):
    ...
    parent_task = models.ForeignKey(
        'Project_Task', on_delete=models.CASCADE, blank=True, null=True)
    ...
    assigned_to = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,
                                    blank=True, null=True, related_name='project_task_assigned_to')
    assignee = models.ForeignKey(Employee, on_delete=models.CASCADE,
                                 blank=True, null=True, related_name='project_task_assignee')
    percentage = models.PositiveSmallIntegerField(default=0)
    periority = models.CharField(
        max_length=50, blank=True, null=True, choices=periority_list)
