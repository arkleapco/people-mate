...
class JobRollInlineAdmin(admin.TabularInline):
    fields = (
        ...
        'manager',
        'position',
        'employee_department_oracle_erp_id',
        'contract_type',
        'payroll',
        'start_date',
        'end_date',
...
@admin.register(UploadEmployeeVariableElement_Industerial)
class UploadEmployeeVariableElement_IndusterialAdmin(ImportExportModelAdmin):
